...
function add_theme_pages() {
	...
	// Archives
	// add_theme_page( 
	// 	__( 'Edit archive page', THEME_TEXT_DOMAIN ), 
	// 	__( 'Archive', THEME_TEXT_DOMAIN ), 
	// 	'edit_theme_options', 
	// 	'theme-archive', 
	// 	'theme_page_form' 
	// );
	...
	if ( 
		...
		if ( isset( $_GET[ 'message' ] ) ) {
			if ( $_GET[ 'message' ] === '1' ) {
				...
				$message = __( 'Page has been succesfully saved', THEME_TEXT_DOMAIN );

			} else if ( $_GET[ 'message' ] === '2' ) {

				// Set CSS class and message for notice
				$class = 'notice notice-error is-dismissible';
				$message = __( 'Something went wrong', THEME_TEXT_DOMAIN );
			...
			<div id="poststuff">
				<div id="post-body" class="metabox-holder columns-1">
					...
					<div id="post-body-content">
						...
						<div id="titlediv">
							<div id="titlewrap">
								<label class="screen-reader-text" id="title-prompt-text" for="title">' . __( 'Fill in the title', THEME_TEXT_DOMAIN ) . '</label>
						...
						<div id="wp-content-wrap" class="wp-core-ui wp-editor-wrap tmce-active has-dfw" style="padding-top:25px;">';
							...
							submit_button( __( 'Save', THEME_TEXT_DOMAIN ), 'primary' );
						echo 
						'</div>
					</form>
				</div>
