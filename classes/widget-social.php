		...
		echo $args['before_widget'];
			...
			echo '<div class="socials">';
				echo '<ul class="socials__list">';
					...
					if( $facebook ) { echo '<li class="socials__item"><a class="socials__link" href="' . $facebook . '" rel="noreferrer" target="_blank" title="Facebook"><div class="socials__icon"><i aria-label="Facebook" class="fab fa-facebook-f"></i></div>' . ( ( $show_labels === true ) ? '<span class="socials__name">Facebook</span>' : '' ) . '</a></li>'; }
					if( $twitter ) { echo '<li class="socials__item"><a class="socials__link" href="' . $twitter . '" rel="noreferrer" target="_blank" title="Twitter"><div class="socials__icon"><i aria-label="Twitter" class="fab fa-twitter"></i></div>' . ( ( $show_labels === true ) ? '<span class="socials__name">Twitter</span>' : '' ) . '</a></li>'; }
					if( $instagram ) { echo '<li class="socials__item"><a class="socials__link" href="' . $instagram . '" rel="noreferrer" target="_blank" title="Instagram"><div class="socials__icon"><i aria-label="Instagram" class="fab fa-instagram"></i></div>' . ( ( $show_labels === true ) ? '<span class="socials__name">Instagram</span>' : '' ) . '</a></li>'; }
					if( $pinterest ) { echo '<li class="socials__item"><a class="socials__link" href="' . $pinterest . '" rel="noreferrer" target="_blank" title="Pinterest"><div class="socials__icon"><i aria-label="Pinterest" class="fab fa-pinterest"></i></div>' . ( ( $show_labels === true ) ? '<span class="socials__name">Pinterest</span>' : '' ) . '</a></li>'; }
					if( $google ) { echo '<li class="socials__item"><a class="socials__link" href="' . $google . '" rel="noreferrer" target="_blank" title="Google+"><div class="socials__icon"><i aria-label="Google+" class="fab fa-google-plus"></i></div>' . ( ( $show_labels === true ) ? '<span class="socials__name">Google+</span>' : '' ) . '</a></li>'; }
					if( $linkedin ) { echo '<li class="socials__item"><a class="socials__link" href="' . $linkedin . '" rel="noreferrer" target="_blank" title="LinkedIn"><div class="socials__icon"><i aria-label="Linkedin" class="fab fa-linkedin-in"></i></div>' . ( ( $show_labels === true ) ? '<span class="socials__name">LinkedIn</span>' : '' ) . '</a></li>'; }
					if( $youtube ) { echo '<li class="socials__item"><a class="socials__link" href="' . $youtube . '" rel="noreferrer" target="_blank" title="Youtube"><div class="socials__icon"><i aria-label="Youtube" class="fab fa-youtube"></i></div>' . ( ( $show_labels === true ) ? '<span class="socials__name">Youtube</span>' : '' ) . '</a></li>'; }
